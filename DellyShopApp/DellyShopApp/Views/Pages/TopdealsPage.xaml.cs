...
namespace DellyShopApp.Views.Pages
{
    ...
    public partial class TopdealsPage
    {
        ...
        private async void InittTopdealsPage()
        {
            BestSeller.FlowItemsSource = await DataService.GetLastVisitedProductsByOrganizations(orgId);
        }
